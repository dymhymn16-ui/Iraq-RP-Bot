...
client.on("interactionCreate", async interaction => {
  ...
  try {
    ...
    if (interaction.commandName === "disbandgang") {
      ...
      // إزالة رتب العصابة (زعيم وأعضاء ونواب) عن كافة أعضاء العصابة
      for (const memberId of gangData.members) {
        try {
          ...
          // تجاهل الأعضاء الذين غادروا السيرفر
        }
      }

      // حذف العصابة نهائياً من قاعدة البيانات
